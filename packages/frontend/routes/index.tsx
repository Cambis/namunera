...
const Home = (
  ...
  <Layout headerProps={navItems} footerLinks={navItems} siteConfig={siteConfig}>
    ...
    <Container>
      <h1 className="text-4xl font-bold text-center my-6">{siteConfig?.title}</h1>
      {page?.elementalArea && (
        <ElementalArea
    ...
    <Container>
      <h2 class="text-3xl font-bold text-center my-6">Innovation Week Showcase 2022</h2>
    </Container>
    <ProjectShowcase pages={pages} />
    <Container>
      <a class="px-4 py-2 inline-block text-center rounded-md bg-yellow-200 hover:bg-yellow-300" href="/projects">Click here to see more</a>
    </Container>
  </Layout>
);
